...
export function* SETUP() {
  ...
  reduxStore.dispatch({
    ...
    payload: {
      setting: 'setPeriode',
      value: {
        currentMonthNum: datePeriod.currentMonthNumID,
        currentMonthName: datePeriod.currentMonthNameID,
        currentDate: datePeriod.todayID,
        currentStartMonth: datePeriod.startMonthID,
        currentEndMonth: datePeriod.endMonthID,
      },
    },
  })
