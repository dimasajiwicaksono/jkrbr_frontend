...
class PermohonanTestUrine extends Component {
            ...
            <div className={`${styles.cardLogin}`}>
              <div className="p-4 m-0">
                <Link to="/membership/layanan_masyarakat/p2m" className='utils__link--blue utils__link mt-2 mr-1'>
                  ...
                  <span style={{fontSize: '1.5em', margin: 10}}>Permohonan Test Urine</span>
                </Link>
                <Spin spinning={false}>
                  <Form>
...
export default Form.create()(PermohonanTestUrine)
